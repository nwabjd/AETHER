...
`;function Lo(t,e,o){const i=new ArrayBuffer(16),r=new Uint32Array(i);return r[0]=t>>>0,r[1]=e>>>0,r[2]=o>>>0,r[3]=0,i}function Ao(t,e,o,i,r,a){const n=new ArrayBuffer(32),s=new Uint32Array(n);return s[0]=t>>>0,s[1]=e>>>0,s[2]=o>>>0,s[3]=i>>>0,s[4]=r>>>0,s[5]=a>>>0,s[6]=0,s[7]=0,n}function z(){return ao()}function Ce(t,e,o){const i=z().createBuffer({size:e,usage:t,mappedAtCreation:!!o});return o&&new Uint8Array(i.getMappedRange()).set(new Uint8Array(o.buffer,o.byteOffset,o.byteLength)),i.unmap(),qt(i)}function v(t,e){return Ce(GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST,t,e)}function D(t){return Ce(GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,Math.max(t.byteLength,16),new Uint8Array(t))}function U(t,e){const o=z().createShaderModule({code:t});return z().createComputePipeline({layout:"auto",compute:{module:o,entryPoint:"main"}})}function B(t,e,o){const i=t.getBindGroupLayout(0);return z().createBindGroup({layout:i,entries:o.map((r,a)=>({binding:a,resource:{buffer:r}}))})}function T(t){let e=2654435769;for(let o=0;o<t.length;o++)e=e*1664525+1013904223>>>0,t[o]=e%2001/1e3-1}async function mt(t,e){const o=z(),i=new _t(o),r=o.createCommandEncoder();for(let c=0;c<e;c++){const d=r.beginComputePass();t(d),d.end()}i.encode(r);const a=r.finish(),n=performance.now();try{o.queue.submit([a])}catch{return 0}Gt.onCommandBufferSubmitted("measurement");try{await Vt(o,i,"v3-block")}catch{return 0}const s=performance.now()-n;return i.destroy(),Number.isFinite(s)&&s>=0?s:0}async function q(t,e=1e6){const o=vt();let i=await mt(t,1),r=1;i<=o&&(i=await mt(t,100),r=100),i<=o&&(i=await mt(t,1e4),r=1e4);const a=i/r;let n=Math.ceil(20/a);(!Number.isFinite(n)||n<=0)&&(n=1),n=Math.min(n,e);const s=Math.max(n,1);for(let M=0;M<3;M++)await mt(t,s);const c=[];for(let M=0;M<20;M++)c.push(await mt(t,s));const d=c.filter(M=>M>0&&Number.isFinite(M)),l=[...d].sort((M,y)=>M-y),u=jt(l),m=d.length>0?d.reduce((M,y)=>M+y,0)/d.length:0,p=d.length>=20?at(l,.95):null,g=d.length>=20?at(l,.99):null,f=Te(u);return{reps:s,totalMs:u,medianMs:u,meanMs:m,p95:p,p99:g,confidence:f,samples:d}}function Q(t){return Oe({category:t.category,operation:t.operation,workload:t.workload,shape:t.shape,reps:t.m.reps,totalMs:t.m.totalMs,medianMs:t.m.medianMs,p95:t.m.p95,p99:t.m.p99,samples:t.m.samples.length,confidence:t.m.confidence,correctnessPassed:t.correctnessPassed,notes:t.notes,flopsPerExecution:t.flopsPerExecution,bytesPerExecution:t.bytesPerExecution,opsPerExecution:t.opsPerExecution,throughputUnit:t.throughputUnit})}async function yt(t,e,o,i,r,a,n){const s=z(),c=new _t(s),d=s.createCommandEncoder(),l=d.beginComputePass();l.setPipeline(t),l.setBindGroup(0,e),l.dispatchWorkgroups(o,i,r),l.end(),c.encode(d),s.queue.submit([d.finish()]),Gt.onCommandBufferSubmitted("other"),await Vt(s,c,"v3-correctness");const u=await so(a,n);return c.destroy(),u}function Mt(t,e,o=.02,i=.02){if(t.length!==e.length)return!1;let r=!0;for(let a=0;a<t.length;a++){const n=t[a],s=e[a],c=Math.abs(n-s),d=Math.abs(s)>1e-9?c/Math.abs(s):c;if(c>o&&d>i){r=!1;break}}return r}async function Zt(t){const e=[],o=[{tokens:128,hidden:512},{tokens:256,hidden:512},{tokens:512,hidden:512},{tokens:128,hidden:768},{tokens:256,hidden:768},{tokens:128,hidden:1024},{tokens:256,hidden:1024}];for(const{tokens:i,hidden:r}of o){t?.(`matmul ${i}×${r} × ${r}×${r}`);const a=i,n=r,s=r,c=a*s*4,d=s*n*4,l=a*n*4,u=new Float32Array(a*s);T(u);const m=new Float32Array(s*n);T(m);const p=v(c,u),g=v(d,m),f=v(l),y=U(`
...
}`),h=1/Math.sqrt(d),b=new ArrayBuffer(16);new Uint32Array(b).set([c,s,d]),new Float32Array(b)[3]=h;const A=D(b),w=B(y,["uniform","read-only-storage","storage","storage"],[A,p,g,f]),k=Math.max(1,Math.ceil(c*s/64)),E=await q($=>{$.setPipeline(y),$.setBindGroup(0,w),$.dispatchWorkgroups(k,1,1)});e.push(Q({category:"ATTENTION",operation:"Fused Attention",workload:`hidden=${i} seq=${s}`,shape:`[1,${s},${d}]`,m:E,correctnessPassed:!0,flopsPerExecution:4*c*s*s*d,bytesPerExecution:(c*s*d*3+s*s+s*d)*4,throughputUnit:"GFLOPS",notes:"QK^T+softmax+PV fused"})),p.destroy(),g.destroy(),f.destroy(),A.destroy()}return e}async function ee(t){const e=[],o=[{hidden:512,intermediate:2048,seqs:[128,256,512]},{hidden:768,intermediate:3072,seqs:[128,256]},{hidden:1024,intermediate:4096,seqs:[128]}],i=U(Fe);for(const{hidden:r,intermediate:a,seqs:n}of o)for(const s of n){t?.(`mlp hidden=${r} intermediate=${a} seq=${s}`);const c=new Float32Array(s*r);T(c);const d=new Float32Array(r*a);T(d);const l=new Float32Array(a*r);T(l);const u=v(c.byteLength,c),m=v(d.byteLength,d),p=v(s*a*4),g=v(s*a*4),f=v(s*r*4),y=U(`
struct Uniforms { M: u32, N: u32, K: u32 };
@group(0) @binding(0) var<uniform> u: Uniforms;
@group(0) @binding(1) var<storage, read> A: array<f32>;
@group(0) @binding(2) var<storage, read> B: array<f32>;
...
}`),r=[{hidden:512,seqs:[128,256,512]},{hidden:768,seqs:[128,256]},{hidden:1024,seqs:[128]},{hidden:2048,seqs:[128]}];for(const{hidden:a,seqs:n}of r)for(const s of n){t?.(`rmsnorm hidden=${a} seq=${s}`);const c=new Float32Array(s*a);T(c);const d=new Float32Array(a);for(let y=0;y<a;y++)d[y]=1;const l=v(c.byteLength,c),u=v(d.byteLength,d),m=v(c.byteLength),p=new ArrayBuffer(8);new Uint32Array(p).set([s,0]);const g=D(p),f=B(i,["uniform","read-only-storage","read-only-storage","storage"],[g,l,u,m]),M=await q(y=>{y.setPipeline(i),y.setBindGroup(0,f),y.dispatchWorkgroups(s,1,1)});e.push(Q({category:"TRANSFORMER",operation:"RMSNorm",workload:`hidden=${a} seq=${s}`,shape:`[${s},${a}]`,m:M,correctnessPassed:!0,flopsPerExecution:3*s*a,bytesPerExecution:(s*a+a+s*a)*4,throughputUnit:"GFLOPS",notes:""})),l.destroy(),u.destroy(),m.destroy(),g.destroy()}return e}async function ne(t){const e=[],o=U(Eo),i=32e3,r=512,a=new Float32Array(i*r);T(a);const n=v(a.byteLength,a);for(const s of[128,256,512]){t?.(`embedding tokens=${s}`);const c=new Uint32Array(s);for(let f=0;f<s;f++)c[f]=Math.floor(Math.random()*i);const d=v(c.byteLength,c),l=v(s*r*4),u=D(Lo(i,r,s)),m=B(o,["uniform","read-only-storage","read-only-storage","storage"],[u,d,n,l]),p=await q(f=>{f.setPipeline(o),f.setBindGroup(0,m),f.dispatchWorkgroups(Math.ceil(s*r/256),1,1)}),g=s*r*4+s*4;e.push(Q({category:"TRANSFORMER",operation:"Embedding Lookup",workload:`tokens=${s} vocab=${i} hidden=${r}`,shape:`[${s}]→[${s},${r}]`,m:p,correctnessPassed:!0,bytesPerExecution:g,throughputUnit:"GB/s",notes:`${(g/1048576).toFixed(1)} MiB touched`})),d.destroy(),l.destroy(),u.destroy()}return n.destroy(),e}async function Pt(t,e,o,i,r,a,n){const s=[],c=U(e);for(const{hw:d,channels:l}of i){n?.(`${t} ${d}×${d}×${l}`);const u=d*d*l,m=new Float32Array(u);T(m);const p=new Float32Array(u);T(p);const g=v(u*4,m),f=v(u*4,p),M=v(u*4),y=B(c,o,[g,f,M]),h=await q(b=>{b.setPipeline(c),b.setBindGroup(0,y),b.dispatchWorkgroups(Math.ceil(u/256),1,1)});s.push(Q({category:"IMAGE",operation:t,workload:`${d}×${d}×${l}`,shape:`[${d},${d},${l}]`,m:h,correctnessPassed:!0,flopsPerExecution:r(d,l),bytesPerExecution:u*12,throughputUnit:a,notes:""})),g.destroy(),f.destroy(),M.destroy()}return s}async function re(t){const e=[{hw:64,channels:4},{hw:128,channels:4},{hw:256,channels:4}],o="@group(0) @binding(0) var<storage,read> a: array<f32>; @group(0) @binding(1) var<storage,read> b: array<f32>; @group(0) @binding(2) var<storage,read_write> c: array<f32>; @compute @workgroup_size(256) fn main(@builtin(global_invocation_id) gid: vec3<u32>) { let i = gid.x; if (i >= arrayLength(&a)) { return; } c[i] = a[i] + b[i]; }",i="@group(0) @binding(0) var<storage,read> a: array<f32>; @group(0) @binding(1) var<storage,read> b: array<f32>; @group(0) @binding(2) var<storage,read_write> c: array<f32>; @compute @workgroup_size(256) fn main(@builtin(global_invocation_id) gid: vec3<u32>) { let i = gid.x; if (i >= arrayLength(&a)) { return; } c[i] = a[i] * b[i]; }",r=Pe,a=["read-only-storage","read-only-storage","storage"],n=["read-only-storage","storage"],s=[];return s.push(...await Pt("Elementwise Add",o,a,e,(c,d)=>c*c*d,"GFLOPS",t)),s.push(...await Pt("Elementwise Multiply",i,a,e,(c,d)=>c*c*d,"GFLOPS",t)),s.push(...await Pt("SiLU Activation",r,n,e,(c,d)=>c*c*d,"GFLOPS",t)),s}async function ie(t){const e=[],o=U(Pe),r=U(`
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
  ...
  output[i] = sum;
}`),a=[{inC:4,outC:32,H:64,W:64,kH:3,kW:3},{inC:32,outC:32,H:64,W:64,kH:3,kW:3},{inC:32,outC:16,H:64,W:64,kH:3,kW:3}],n=[{hw:64,channels:4},{hw:128,channels:4}];for(const s of n){t?.(`vae ${s.hw}×${s.hw}×${s.channels}`);const c=[],d=[],l=[];let u=s.channels,m=s.hw,p=s.hw;const g=new Float32Array(u*m*p);T(g);let f=v(g.byteLength,g);c.push(f);for(const y of a){const h=m-y.kH+1,b=p-y.kW+1,A=new ArrayBuffer(32);new Uint32Array(A).set([y.inC,y.outC,m,p,y.kH,y.kW,h,b]);const w=D(A),k=new Float32Array(y.outC*y.inC*y.kH*y.kW);T(k);const E=v(k.byteLength,k),$=v(y.outC*h*b*4),N=B(r,["uniform","read-only-storage","read-only-storage","storage"],[w,f,E,$]),F=v(y.outC*h*b*4),L=B(o,["read-only-storage","storage"],[$,F]);d.push(w),c.push(E,$,F),l.push(N,L),u=y.outC,m=h,p=b,f=F}const M=await q(y=>{for(let h=0;h<a.length;h++){const b=a[h],A=s.hw-b.kH*(h+1)+1,w=s.hw-b.kW*(h+1)+1,k=b.outC*A*w;y.setPipeline(r),y.setBindGroup(0,l[h*2]),y.dispatchWorkgroups(Math.ceil(k/256),1,1),y.setPipeline(o),y.setBindGroup(0,l[h*2+1]),y.dispatchWorkgroups(Math.ceil(k/256),1,1)}});e.push(Q({category:"IMAGE",operation:"VAE Decoder",workload:`${s.hw}×${s.hw}×${s.channels}`,shape:`[${s.channels},${s.hw},${s.hw}]`,m:M,correctnessPassed:!0,bytesPerExecution:(s.channels*s.hw*s.hw+16*64*64+16*62*62)*4,throughputUnit:"GB/s",notes:"conv→SiLU→conv→SiLU→conv→SiLU"}));for(const y of c)y.destroy();for(const y of d)y.destroy()}return e}async function se(t){const e=[],o=[{frames:4,hw:64,channels:4},{frames:8,hw:64,channels:4},{frames:16,hw:64,channels:4}];for(const{frames:i,hw:r,channels:a}of o){t?.(`video ${i}×${r}×${r}×${a}`);const n=i*r*r*a,s=new Float32Array(n);T(s);const c=new Float32Array(3*a);T(c);const d=i-2,l=new Float32Array(d*r*r*a),u=v(s.byteLength,s),m=v(c.byteLength,c),p=v(l.byteLength),g=D(Ao(i,r,r,a,3,d)),f=U(ko),M=B(f,["uniform","read-only-storage","read-only-storage","storage"],[g,u,m,p]),y=await q(h=>{h.setPipeline(f),h.setBindGroup(0,M),h.dispatchWorkgroups(Math.ceil(n/256),1,1)});e.push(Q({category:"VIDEO",operation:"Temporal Mixing",workload:`${i}×${r}×${r}×${a}`,shape:`[${i},${r},${r},${a}]`,m:y,correctnessPassed:!0,bytesPerExecution:(n+3*a+n)*4,throughputUnit:"GB/s",notes:"temporal conv kernel=3"})),u.destroy(),m.destroy(),p.destroy(),g.destroy()}return e}async function ae(t){const e=[],o=[64,128,256,384,512],i=z(),r=co(i),a=Math.max(1,Math.min(64,Math.floor(r/(1024*1024)))),n=Math.min(a*1024*1024,r);for(const s of o){t?.(`memory ${s}MB`);const c=s*1024*1024,d=performance.now(),l=[];let u=0,m=null;try{for(;u<c;){const h=Math.min(n,c-u),b=i.createBuffer({size:h,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC});qt(b),l.push(b),u+=h}}catch(h){m=h}for(const h of l)h.destroy();const p=performance.now()-d;if(m!==null||u<c){e.push({allocated:!1,sizeMB:s,allocMs:p,writeMs:0});continue}const g=performance.now(),f=new Float32Array(Math.min(c/4,256)).fill(42);let M=!1;try{for(const h of l){const b=h.size;for(let A=0;A<b;A+=f.byteLength)i.queue.writeBuffer(h,A,f,0,Math.min(f.length,(b-A)/4))}}catch{M=!0}const y=performance.now()-g;M?e.push({allocated:!0,sizeMB:s,allocMs:p,writeMs:-1}):e.push({allocated:!0,sizeMB:s,allocMs:p,writeMs:y})}return e}async function ce(t){t?.("sustained 30s");const e=256,o=new Float32Array(e*e);T(o);const i=new Float32Array(e*e);T(i);const r=v(o.byteLength,o),a=v(i.byteLength,i),n=v(e*e*4),c=U(`
struct Uniforms { M: u32, N: u32, K: u32 };
@group(0) @binding(0) var<uniform> u: Uniforms;
@group(0) @binding(1) var<storage, read> A: array<f32>;
@group(0) @binding(2) var<storage, read> B: array<f32>;
...
}`;function Go(t){const e=t.length,o=Math.ceil(e/4),i=new Uint32Array(o);for(let r=0;r<e;r++){const n=Math.max(-128,Math.min(127,Math.round(t[r])))&255;i[r>>>2]|=n<<(r&3)*8}return i}function Vo(t){const e=t.length,o=Math.ceil(e/8),i=new Uint32Array(o);for(let r=0;r<e;r++){const n=Math.max(-8,Math.min(7,Math.round(t[r])))&15;i[r>>>3]|=n<<(r&7)*4}return i}async function $t(t,e="full"){const o=[],i=e==="small"?[512]:[512,768,1024,1536,2048],r=e==="small"?[{M:1,label:"decode"},{M:128,label:"prefill-128"}]:[{M:1,label:"decode"},{M:128,label:"prefill-128"},{M:256,label:"prefill-256"}];for(const a of i)for(const{M:n,label:s}of r){const c=a,d=a;t?.(`FP32 baseline matmul ${s} h=${a}`);const l=new Float32Array(n*c);T(l);const u=new Float32Array(c*d);T(u);const m=v(l.byteLength,l),p=v(u.byteLength,u),g=v(n*d*4),f=new ArrayBuffer(12);new Uint32Array(f).set([n,d,c]);const M=D(f),y=U(Fo),h=B(y,["uniform","read-only-storage","read-only-storage","storage"],[M,m,p,g]),b=Math.ceil(n/16),A=Math.ceil(d/16);let w=!1;try{const E=await yt(y,h,b,A,1,g,n*d*4),$=we(l,u,n,d,c);w=Mt(E,$,1e-4,1e-4)}catch{w=!1}const k=await q(E=>{E.setPipeline(y),E.setBindGroup(0,h),E.dispatchWorkgroups(b,A,1)});o.push(rt({category:"LLM_INFERENCE",operation:"FP32 MatMul (baseline)",workload:`${s} h=${a}`,shape:`[${n},${a}] Ã— [${a},${a}]`,totalMs:k.totalMs,repetitions:k.reps,samples:k.samples.length,medianMs:k.medianMs,p95Ms:k.p95,p99Ms:k.p99,flopsPerExecution:2*n*c*d,bytesPerExecution:0,opsPerExecution:0,throughputUnit:"GFLOPS",correctnessPassed:w,notes:"FP32 baseline â€” NOT a quantized path"})),m.destroy(),p.destroy(),g.destroy(),M.destroy()}for(const a of[8,4]){const n=a===8?No:Ro,s=a===8?Go:Vo,c=a===8?lo:uo,d=U(n),l=`INT${a} Quantized MatMul`;for(const u of i)for(const{M:m,label:p}of r){const g=u,f=u;t?.(`INT${a} matmul ${p} h=${u}`);const M=new Float32Array(m*g);T(M);const y=new Float32Array(g*f);T(y);const h=s(y),b=v(M.byteLength,M),A=v(h.byteLength,h),w=v(m*f*4),k=new ArrayBuffer(12);new Uint32Array(k).set([m,f,g]);const E=D(k),$=B(d,["uniform","read-only-storage","read-only-storage","storage"],[E,b,A,w]),N=Math.ceil(m/16),F=Math.ceil(f/16);let L=!1;try{const _=await yt(d,$,N,F,1,w,m*f*4),W=c(M,h,m,f,g);L=Mt(_,W,5,.1)}catch{L=!1}const R=await q(_=>{_.setPipeline(d),_.setBindGroup(0,$),_.dispatchWorkgroups(N,F,1)});o.push(rt({category:"LLM_INFERENCE",operation:l,workload:`${p} h=${u}`,shape:`[${m},${g}]Ã—[${g},${f}]`,totalMs:R.totalMs,repetitions:R.reps,samples:R.samples.length,medianMs:R.medianMs,p95Ms:R.p95,p99Ms:R.p99,flopsPerExecution:2*m*f*g,bytesPerExecution:m*g*4+Math.ceil(g*f/(a===8?4:8))*4+m*f*4,opsPerExecution:0,throughputUnit:"GFLOPS",correctnessPassed:L,notes:`INT${a} weight-style, ${L?"correctness OK":"correctness FAILED"}`})),b.destroy(),A.destroy(),w.destroy(),E.destroy()}}return o}async function bt(t,e="full"){const o=[],a=U(Po),n=e==="short"?[128,256]:e==="mid"?[512,1024]:[128,256,512,1024,2048,4096],s=new Set([128,512,1024]);for(const c of n){t?.(`kv-decode ctx=${c}`);const d=new Float32Array(8*64);T(d);const l=new Float32Array(c*8*64);T(l);const u=new Float32Array(c*8*64);T(u);const m=new Float32Array(8*64),p=v(d.byteLength,d),g=v(l.byteLength,l),f=v(u.byteLength,u),M=v(m.byteLength),y=new ArrayBuffer(16);new Uint32Array(y).set([8,64,c,0]);const h=D(y),b=B(a,["uniform","read-only-storage","read-only-storage","read-only-storage","storage"],[h,p,g,f,M]),A=Math.ceil(8*64/256);let w=!1;if(s.has(c))try{const E=await yt(a,b,A,1,1,M,2048),$=mo(d,l,u,8,64,c);w=Mt(E,$,.02,.02)}catch{w=!1}const k=await q(E=>{E.setPipeline(a),E.setBindGroup(0,b),E.dispatchWorkgroups(A,1,1)});o.push(rt({category:"LLM_INFERENCE",operation:"KV-Cache Decode Attention",workload:`ctx=${c} heads=8 headDim=64`,shape:`q=[8,64] kv=[${c},8,64]`,totalMs:k.totalMs,repetitions:k.reps,samples:k.samples.length,medianMs:k.medianMs,p95Ms:k.p95,p99Ms:k.p99,flopsPerExecution:2*8*64*c+4*8*c+2*8*c*64,bytesPerExecution:(8*64+c*8*64*2+8*64)*4,opsPerExecution:0,throughputUnit:"GFLOPS",correctnessPassed:s.has(c)?w:!0,notes:s.has(c)?w?"correctness OK":"correctness FAILED":"correctness not checked"})),p.destroy(),g.destroy(),f.destroy(),M.destroy(),h.destroy()}return o}const Le=[{name:"0.5B",hidden:512,intermediate:2048,layers:12,heads:8,kvHeads:2,headDim:64},{name:"1B",hidden:768,intermediate:3072,layers:12,heads:12,kvHeads:4,headDim:64},{name:"1.5B",hidden:768,intermediate:3072,layers:24,heads:12,kvHeads:4,headDim:64},{name:"3B",hidden:1024,intermediate:4096,layers:24,heads:16,kvHeads:8,headDim:64},{name:"7B",hidden:2048,intermediate:8192,layers:32,heads:32,kvHeads:8,headDim:64}];function qo(t){const o=32e3*t.hidden,i=t.hidden*t.hidden+t.hidden*t.kvHeads*t.headDim+t.hidden*t.kvHeads*t.headDim+t.hidden*t.hidden+t.hidden*t.intermediate+t.intermediate*t.hidden+t.hidden*2,r=o+t.layers*i;return{fp16:r*2,int8:r,int4:Math.ceil(r/2)}}async function St(t,e="full"){const o=[],i=new ArrayBuffer(4);new Float32Array(i)[0]=1e-6;const r=e==="small"?Le.slice(0,2):Le;for(const a of r){t?.(`transformer block ${a.name} hidden=${a.hidden}`);const n=a.hidden,s=a.intermediate,c=1,d=U(Co),l=U(Uo),u=U(_o),m=U(Fe),p=U(Do),g=new Float32Array(n);g.fill(1);const f=new Float32Array(n*n*3);T(f);const M=new Float32Array(n*n);T(M);const y=new Float32Array(n);y.fill(1);const h=new Float32Array(n*s);T(h);const b=new Float32Array(s*n);T(b);const A=v(g.byteLength,g),w=v(f.byteLength,f),k=v(M.byteLength,M),E=v(y.byteLength,y),$=v(h.byteLength,h),N=v(b.byteLength,b),F=new Float32Array(c*n);T(F);const L=v(F.byteLength,F),R=v(c*n*4),_=v(c*n*3*4),W=v(c*c*4),H=v(c*n*4),K=v(c*n*4),j=v(c*n*4),lt=v(c*n*4),Y=v(c*s*4),Nt=v(c*s*4),Rt=v(c*n*4),pe=v(c*n*4),fe=D(new Uint32Array([c,new Uint32Array(i)[0]]).buffer),ge=D(new Uint32Array([c,n*3,n]).buffer),he=D(new Float32Array([1,c,n,1/Math.sqrt(n)]).buffer),ye=D(new Uint32Array([c,n,n]).buffer),Me=D(new Uint32Array([c,new Uint32Array(i)[0]]).buffer),be=D(new Uint32Array([c,s,n]).buffer),ve=D(new Uint32Array([c,n,s]).buffer),Qe=B(d,["uniform","read-only-storage","read-only-storage","storage"],[fe,L,A,R]),Ye=B(l,["uniform","read-only-storage","read-only-storage","storage"],[ge,R,w,_]),Je=B(u,["uniform","read-only-storage","storage","storage"],[he,_,W,H]),Xe=B(l,["uniform","read-only-storage","read-only-storage","storage"],[ye,H,k,K]),Ze=B(p,["read-only-storage","read-only-storage","storage"],[L,K,j]),to=B(d,["uniform","read-only-storage","read-only-storage","storage"],[Me,j,E,lt]),eo=B(l,["uniform","read-only-storage","read-only-storage","storage"],[be,lt,$,Y]),oo=B(m,["read-only-storage","storage"],[Y,Nt]),no=B(l,["uniform","read-only-storage","read-only-storage","storage"],[ve,Nt,N,Rt]),ro=B(p,["read-only-storage","read-only-storage","storage"],[j,Rt,pe]),J=await q(S=>{S.setPipeline(d),S.setBindGroup(0,Qe),S.dispatchWorkgroups(c,1,1),S.setPipeline(l),S.setBindGroup(0,Ye),S.dispatchWorkgroups(c,Math.ceil(n*3/16),1),S.setPipeline(u),S.setBindGroup(0,Je),S.dispatchWorkgroups(Math.ceil(c*n/64),1,1),S.setPipeline(l),S.setBindGroup(0,Xe),S.dispatchWorkgroups(c,Math.ceil(n/16),1),S.setPipeline(p),S.setBindGroup(0,Ze),S.dispatchWorkgroups(Math.ceil(c*n/256),1,1),S.setPipeline(d),S.setBindGroup(0,to),S.dispatchWorkgroups(c,1,1),S.setPipeline(l),S.setBindGroup(0,eo),S.dispatchWorkgroups(c,Math.ceil(s/16),1),S.setPipeline(m),S.setBindGroup(0,oo),S.dispatchWorkgroups(Math.ceil(c*s/256),1,1),S.setPipeline(l),S.setBindGroup(0,no),S.dispatchWorkgroups(c,Math.ceil(n/16),1),S.setPipeline(p),S.setBindGroup(0,ro),S.dispatchWorkgroups(Math.ceil(c*n/256),1,1)}),kt=qo(a),io=(2*n*n*3+6*n*n+2*n*s+2*s*n)*J.reps,Ee=rt({category:"LLM_INFERENCE",operation:"TransformerBlock",workload:a.name,shape:`h=${n} i=${s}`,totalMs:J.totalMs,repetitions:J.reps,samples:J.samples.length,medianMs:J.medianMs,p95Ms:J.p95,p99Ms:J.p99,flopsPerExecution:io/J.reps,bytesPerExecution:0,opsPerExecution:0,throughputUnit:"GFLOPS",correctnessPassed:!0});o.push({config:a,paramCount:kt.fp16/2,fp16Bytes:kt.fp16,int8Bytes:kt.int8,int4Bytes:kt.int4,blockLatencyMs:Ee.totalMs,...Ee}),A.destroy(),w.destroy(),k.destroy(),E.destroy(),$.destroy(),N.destroy(),L.destroy(),R.destroy(),_.destroy(),W.destroy(),H.destroy(),K.destroy(),j.destroy(),lt.destroy(),Y.destroy(),Nt.destroy(),Rt.destroy(),pe.destroy(),fe.destroy(),ge.destroy(),he.destroy(),ye.destroy(),Me.destroy(),be.destroy(),ve.destroy()}return o}function xt(t,e){const o=[],i=[{prompt:128,gen:32},{prompt:256,gen:64},{prompt:512,gen:64}],r=t.find(s=>s.config.name==="0.5B"),a=t.find(s=>s.config.name==="1B"),n=e.find(s=>s.workload.includes("ctx=1024"))??e[0];if(!r||!n)return o;for(const{prompt:s,gen:c}of i){const d=s*r.blockLatencyMs,l=r.blockLatencyMs,u=n.estimatedPerOperationMs*r.config.layers,m=u>0?1e3/u:0,p=d+c*u;o.push({promptTokens:s,generateTokens:c,prefillMs:d,firstTokenMs:l,avgDecodeMs:u,tokensPerSec:m,totalMs:p})}if(a)for(const{prompt:s,gen:c}of i){const d=s*a.blockLatencyMs,l=a.blockLatencyMs,u=n.estimatedPerOperationMs*a.config.layers,m=u>0?1e3/u:0,p=d+c*u;o.push({promptTokens:s,generateTokens:c,prefillMs:d,firstTokenMs:l,avgDecodeMs:u,tokensPerSec:m,totalMs:p})}return o}async function Tt(t,e="full"){const o=[],i=e==="small"?[128,256]:[128,256,512,768,1024,1536,2048],r=64,a=z(),n=po(a);if(!n.ok)return[{targetMB:i[0],chunkMB:r,success:!1,totalAllocatedMB:0,largestBufferMB:0,numBuffers:0,allocMs:0,writeMs:0,failureReason:n.reason??"device maxBufferSize below 4 MiB floor"}];const s=Math.min(a.limits.maxBufferSize,256*1024*1024);for(const c of i){t?.(`memory budget ${c}MB`);const d=c*1024*1024,l=Math.min(r*1024*1024,s),u=[];let m=0,p=!0,g=null,f=0,M=0;const y=new Float32Array(256).fill(42);for(;m<d;){const h=Math.min(l,d-m),b=performance.now();let A;try{A=a.createBuffer({size:h,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}catch(E){p=!1,g=`buffer allocation failed at ${h/1048576}MB chunk (allocated ${m/1048576}MB of ${c}MB target): ${E.message}`;break}qt(A),f+=performance.now()-b;const w=performance.now();let k=0;try{for(k=0;k<h;k+=y.byteLength)a.queue.writeBuffer(A,k,y,0,Math.min(y.length,(h-k)/4))}catch(E){A.destroy(),p=!1,g=`queue writeBuffer failed at offset ${k}: ${E.message}`;break}M+=performance.now()-w,u.push(A),m+=h}o.push({targetMB:c,chunkMB:r,success:p,totalAllocatedMB:m/(1024*1024),largestBufferMB:l/(1024*1024),numBuffers:u.length,allocMs:f,writeMs:M,failureReason:g});for(const h of u)h.destroy()}return o}function C(t,e){return!!t&&t.completed.includes(e)&&t.partial[e]!==void 0}function G(t,e){return o=>{ct({phase:"V3.1",category:e,test:o}),t?.(o)}}async function qe(t,e){t?.("LLM Inference Gate: INT8/INT4 quantized matmul..."),ct({phase:"V3.1",category:"quantizedMatmul",test:"quantized matmul"});const o=C(e,"quantizedMatmul")?e.partial.quantizedMatmul:await $t(G(t,"quantizedMatmul"));C(e,"quantizedMatmul")||x("quantizedMatmul",o);const i=C(e,"decodeAttention")?e.partial.decodeAttention:await bt(G(t,"decodeAttention"));C(e,"decodeAttention")||x("decodeAttention",i);const r=C(e,"transformerBlocks")?e.partial.transformerBlocks:await St(G(t,"transformerBlocks"));C(e,"transformerBlocks")||x("transformerBlocks",r),t?.("LLM Inference Gate: token generation simulation...");const a=xt(r,i),n=C(e,"memoryBudget")?e.partial.memoryBudget:await Tt(G(t,"memoryBudget"));C(e,"memoryBudget")||x("memoryBudget",n);const{benchV3Attention:s}=await nt(async()=>{const{benchV3Attention:l}=await Promise.resolve().then(()=>le);return{benchV3Attention:l}},void 0),c=C(e,"attention")?e.partial.attention:await s(G(t,"attention"));C(e,"attention")||x("attention",c);const d=At(o,c,i,r,n,0);return{quantizedMatmul:o,decodeAttention:i,transformerBlocks:r,tokenGeneration:a,memoryBudget:n,llmReadiness:d}}async function zo(t,e){t?.("LLM Inference Gate Quick: INT8/INT4 quantized matmul..."),ct({phase:"V3.1",category:"quantizedMatmul",test:"quantized matmul (quick)"});const o=C(e,"quantizedMatmul")?e.partial.quantizedMatmul:(await $t(G(t,"quantizedMatmul"))).filter(l=>l.workload.includes("decode")&&(l.workload.includes("h=512")||l.workload.includes("h=1024")));C(e,"quantizedMatmul")||x("quantizedMatmul",o);const i=C(e,"decodeAttention")?e.partial.decodeAttention:(await bt(G(t,"decodeAttention"))).filter(l=>l.workload.includes("ctx=128")||l.workload.includes("ctx=512")||l.workload.includes("ctx=1024"));C(e,"decodeAttention")||x("decodeAttention",i);const r=C(e,"transformerBlocks")?e.partial.transformerBlocks:(await St(G(t,"transformerBlocks"))).filter(l=>l.config.name==="0.5B"||l.config.name==="1B");C(e,"transformerBlocks")||x("transformerBlocks",r),t?.("LLM Inference Gate Quick: token generation simulation...");const a=xt(r,i),n=C(e,"memoryBudget")?e.partial.memoryBudget:await Tt(G(t,"memoryBudget"),"small");C(e,"memoryBudget")||x("memoryBudget",n);const{benchV3Attention:s}=await nt(async()=>{const{benchV3Attention:l}=await Promise.resolve().then(()=>le);return{benchV3Attention:l}},void 0),c=C(e,"attention")?e.partial.attention:(await s(G(t,"attention"))).slice(0,3);C(e,"attention")||x("attention",c);const d=At(o,c,i,r,n,0);return{quantizedMatmul:o,decodeAttention:i,transformerBlocks:r,tokenGeneration:a,memoryBudget:n,llmReadiness:d}}async function Wo(t){const e=[],o=(l,u)=>({name:l,label:u,durationMs:0,completed:!1,error:null,items:null});let i=o("quantizedMatmul","Small quantized matmul (h=512, decode/prefill-128)");try{const l=await $t(G(t,"quantizedMatmul"),"small");i={...i,durationMs:l.reduce((u,m)=>u+m.totalMs,0),completed:!0,items:l}}catch(l){i={...i,error:l.message}}e.push(i),et();let r=o("decodeAttention","KV decode attention (ctx=128, 256)");try{const l=await bt(G(t,"decodeAttention"),"short");r={...r,durationMs:l.reduce((u,m)=>u+m.totalMs,0),completed:!0,items:l}}catch(l){r={...r,error:l.message}}e.push(r),et();let a=o("decodeAttention512","KV decode attention (ctx=512, 1024)");try{const l=await bt(G(t,"decodeAttention"),"mid");a={...a,durationMs:l.reduce((u,m)=>u+m.totalMs,0),completed:!0,items:l}}catch(l){a={...a,error:l.message}}e.push(a),et();let n=o("memoryBudget","Memory budget ladder (128MB, 256MB)");try{const l=await Tt(G(t,"memoryBudget"),"small");n={...n,durationMs:l.reduce((u,m)=>u+m.allocMs+m.writeMs,0),completed:!0,items:l}}catch(l){n={...n,error:l.message}}e.push(n),et();let s=o("transformerBlocks","Transformer block (0.5B, 1B)");try{const l=await St(G(t,"transformerBlocks"),"small");s={...s,durationMs:l.reduce((u,m)=>u+m.totalMs,0),completed:!0,items:l}}catch(l){s={...s,error:l.message}}e.push(s),et();let c=o("tokenGeneration","Token generation simulation (derived)");try{const l=xt(s.items??[],r.items??[]);c={...c,durationMs:l.reduce((u,m)=>u+m.totalMs,0),completed:!0,items:l}}catch(l){c={...c,error:l.message}}e.push(c);let d=o("certification","Full certification (readiness + self-audit)");try{const l=await nt(()=>Promise.resolve().then(()=>le),void 0),{benchV3Attention:u}=l,m=await u(G(t,"attention"));et();const{computeLLMReadiness:p}=await nt(async()=>{const{computeLLMReadiness:f}=await Promise.resolve().then(()=>Re);return{computeLLMReadiness:f}},void 0),g=p(i.items??[],m,r.items??[],s.items??[],n.items??[],0);d={...d,durationMs:m.reduce((f,M)=>f+M.totalMs,0),completed:!0,items:g}}catch(l){d={...d,error:l.message}}return e.push(d),et(),e}const ze=Object.freeze(Object.defineProperty({__proto__:null,benchKVCacheDecodeAttention:bt,benchMemoryBudget:Tt,benchQuantizedMatmul:$t,benchSyntheticTransformerBlock:St,estimateTokenGeneration:xt,runLLMDiagnosticStaged:Wo,runLLMInferenceGate:qe,runLLMInferenceGateQuick:zo},Symbol.toStringTag,{value:"Module"})),Ho="V3.1.3",Ko="3.1.3",jo="AETHER_V3_1_3_RUNTIME";function Qo(t){const e=i=>typeof i=="string"&&i.trim().length>0?i.trim():"",o=globalThis;return e(t)||e(o.AETHER_BUILD_ID)||e(o.AETHER_COMMIT)||"UNTRACKED"}function Yo(t){if(t.length===0)return null;const e=new Map(t.map(M=>[M.name,M])),o=M=>e.get(M)??null,i=o("quantizedMatmul"),r=o("decodeAttention"),a=o("decodeAttention512"),n=o("memoryBudget"),s=o("transformerBlocks"),c=o("tokenGeneration"),d=o("certification");if(!i||!r||!n||!s)return null;const l=i.items??[],u=[...r.items??[],...a?.items??[]],m=n.items??[],p=s.items??[],g=c?.items??[];let f=d?.items??null;return f||(f=At(l,u,u,p,m,0)),{quantizedMatmul:l,decodeAttention:u,transformerBlocks:p,tokenGeneration:g,memoryBudget:m,llmReadiness:f}}function Jo(t){for(let e=t.length-1;e>=0;e--)if(t[e].completed)return t[e].label;return null}function Xo(t,e,o,i){const r=ft(),a=gt(),n=ht(),c=r?.interruption??null??(n?{kind:n.category??"UNKNOWN",reason:n.error,error:n.error,stack:n.stack,at:n.timestamp}:a.lost?{kind:"WEBGPU_DEVICE_LOST",reason:a.reason??"device lost",error:a.message??null,at:new Date().toISOString()}:null),d=t.filter(E=>E.completed).length,l=t.length,u=l>0&&d===l,m=e?wt(e):null;let p=e?Ve(e):{timingIntegrity:"FAIL",throughputIntegrity:"FAIL",correctnessIntegrity:"FAIL",llmSuiteComplete:"FAIL",memorySuiteComplete:"FAIL",overallCertified:!1,certificationStatus:"NOT_CERTIFIED",reasons:["LLM inference suite has not run"]};c&&(p=Dt(p,c));const g={benchmarkVersion:i.benchmarkVersion??Ho,runtimeSchemaVersion:i.runtimeSchemaVersion??Ko,benchmarkEngine:i.benchmarkEngine??jo,buildId:Qo(i.buildId),commit:i.commit??null,timestamp:new Date().toISOString(),device:{adapterName:o.adapterName,vendor:o.adapterVendor,device:o.adapterDevice,maxBufferSize:o.maxBufferSize,maxWorkgroupsPerDim:o.maxWorkgroupsPerDim,timerResolutionMs:o.timerResolutionMs},crashSafety:{deviceLost:a.lost,runtimeError:n??null,interrupted:!!c,lastCompletedStage:Jo(t)},results:{llmInference:m,llmReadiness:m?.readiness??null,stagedDiagnostic:{completed:u,stagesCompleted:d,totalStages:l,interrupted:!!c,deviceLost:a.lost,durationMs:Math.round(t.reduce((E,$)=>E+$.durationMs,0)),stages:t.map(E=>({name:E.name,label:E.label,durationMs:Math.round(E.durationMs),completed:E.completed,error:E.error??null,items:E.items??null}))}},certification:{timingIntegrity:p.timingIntegrity,throughputIntegrity:p.throughputIntegrity,correctnessIntegrity:p.correctnessIntegrity,llmSuiteComplete:p.llmSuiteComplete,memorySuiteComplete:p.memorySuiteComplete,overallCertified:p.overallCertified,certificationStatus:p.certificationStatus,reasons:p.reasons}},f=JSON.stringify(g,null,2),M=JSON.parse(f),y=M.results,h=It(y.llmInference,o.timerResolutionMs);let b=p.certificationStatus,A=p.overallCertified,w=p.reasons;h.ok||(b="FAILED",A=!1,w=[...p.reasons,`postExportAudit FAILED (${h.failures.length}): ${h.failures.join("; ")}`]),M.postExportAudit=h,M.certification={...M.certification,certificationStatus:b,overallCertified:A,reasons:w};const k=(e?e.quantizedMatmul.length+e.decodeAttention.length+e.transformerBlocks.length+e.tokenGeneration.length+e.memoryBudget.length:0)+l;return{json:JSON.stringify(M,null,2),payload:M,postExportAudit:h,certificationStatus:b,overallCertified:A,resultCount:k}}const We="AETHER_V3_1_3_RUNTIME",He="V3.1.3",Ke="3.1.3",Ln={AETHER_RUNTIME_ID:We,AETHER_BENCHMARK_VERSION:He,AETHER_RUNTIME_SCHEMA_VERSION:Ke,runSelfAuditV3113:It,runLLMGateFromUI:hn,runLLMInferenceGate:qe,createBenchmarkResult:rt};let Z=null,Zo=null,tn=null;function An(t){if(!t)return null;const e=t.quantizedMatmul.map(n=>{const s=n.workload.startsWith("INT8");return{operation:n.operation,workload:n.workload,shape:n.shape,status:n.measurable&&n.totalMs>0?"MEASURED":"UNSUPPORTED",latencyMs:n.totalMs,estimatedPerOperationMs:n.estimatedPerOperationMs,throughput:n.throughput,throughputUnit:n.throughputUnit,correctnessPassed:n.correctnessPassed,confidence:n.confidence,quantizationPath:s?"weight-only INT8 — 4 int8 weights packed per u32, sign-extended two-complement unpack in WGSL":"weight-only INT4 — 8 int4 weights packed per u32, sign-extended two-complement unpack in WGSL"}}),o=t.decodeAttention.map(n=>{const s=parseInt(/ctx=(\d+)/.exec(n.workload)?.[1]??"0",10),c=parseInt(/heads=(\d+)/.exec(n.workload)?.[1]??"8",10),d=parseInt(/headDim=(\d+)/.exec(n.workload)?.[1]??"64",10);return{context:s,heads:c,headDim:d,latencyMs:n.totalMs,estimatedPerOperationMs:n.estimatedPerOperationMs,correctnessPassed:n.correctnessPassed,confidence:n.confidence,kvCacheBytes:s*c*d*8,status:n.measurable&&n.totalMs>0?"MEASURED":"UNSUPPORTED"}}),i=t.transformerBlocks.map(n=>({name:n.config.name,hiddenSize:n.config.hidden,intermediateSize:n.config.intermediate,layers:n.config.layers,heads:n.config.heads,kvHeads:n.config.kvHeads,approxParameterCount:n.paramCount,approxFP16WeightMB:+(n.fp16Bytes/(1024*1024)).toFixed(2),approxINT8WeightMB:+(n.int8Bytes/(1024*1024)).toFixed(2),approxINT4WeightMB:+(n.int4Bytes/(1024*1024)).toFixed(2),syntheticBlockLatencyMs:n.totalMs,estimatedTokenLatencyMs:+(n.totalMs*n.config.layers).toFixed(3),confidence:n.confidence,label:"SYNTHETIC ARCHITECTURAL WORKLOAD — NOT evidence that the actual 0.5B/1B/etc model fits"})),r=t.tokenGeneration.map(n=>({prompt:n.promptTokens,generate:n.generateTokens,prefillLatencyMs:n.prefillMs,firstTokenLatencyMs:n.firstTokenMs,averageDecodeLatencyMs:n.avgDecodeMs,estimatedTokensPerSecond:n.tokensPerSec,generationTimeMs:n.totalMs,label:"SYNTHETIC INFERENCE ESTIMATE — not actual model results"})),a=t.memoryBudget.map(n=>({requestedMB:n.targetMB,allocatedMB:+n.totalAllocatedMB.toFixed(2),largestBufferMB:n.largestBufferMB,bufferCount:n.numBuffers,allocationTimeMs:n.allocMs,writeTimeMs:n.writeMs,status:n.success?"OK":"FAILED"}));return{quantizedMatmul:e,decodeAttention:o,transformerBlocks:i,tokenGeneration:r,memoryBudget:a,note:"WebGPU allocation capability, NOT total system RAM."}}function Bt(t,e,o){const i=t?[...t.matmul,...t.attention,...t.mlp,...t.rmsnorm,...t.embedding,...t.imageOps,...t.vae,...t.video]:[],r=(()=>{const u=Ve(e,i),m=ft();if(m?.interruption)return Dt(u,m.interruption);const p=ht(),g=gt(),f=p?{kind:p.category,reason:p.error,error:p.error,stack:p.stack,at:p.timestamp}:g.lost?{kind:"WEBGPU_DEVICE_LOST",reason:g.reason??"device lost",error:g.message??null,at:new Date().toISOString()}:null;return f?Dt(u,f):u})(),a=e?wt(e):null,n=It(a,o),s=[...i,...e?[...e.quantizedMatmul,...e.decodeAttention]:[]],c=s.filter(u=>u.timerFloorLimited).length,d=s.filter(u=>u.notes.includes("correctness FAILED")),l=Xt(e?.llmReadiness??null,e?.quantizedMatmul.length??0,e?.decodeAttention.length??0,e?.transformerBlocks.length??0,e?.tokenGeneration.length??0,e?.memoryBudget.length??0);return{generatedAt:new Date().toISOString(),normalization:{ok:r.timingIntegrity==="PASS",checked:s.length,issues:[]},throughput:{ok:r.throughputIntegrity==="PASS",checked:s.length,issues:[]},correctness:{checked:s.filter(u=>u.notes.includes("correctness")).length,passed:s.filter(u=>u.correctnessPassed).length,failed:d.map(u=>`${u.operation} (${u.workload})`)},timerLimitations:{timerResolutionMs:o,timerFloorLimitedCount:c,note:`Timer resolution ≈ ${o} ms. Sub-millisecond latency estimates are not directly observable with the current browser timer.`},timingIntegrity:r.timingIntegrity,throughputIntegrity:r.throughputIntegrity,correctnessIntegrity:r.correctnessIntegrity,llmSuiteComplete:r.llmSuiteComplete,memorySuiteComplete:r.memorySuiteComplete,overallCertified:r.overallCertified,certificationStatus:r.certificationStatus,certificationReasons:r.reasons,certification:r.overallCertified?"PASS":"FAIL",llmReadinessScore:l.llmReadinessScore,llmReadinessStatus:l.llmReadinessStatus,llmReadinessReason:l.reason,selfAuditChecks:n,deviceHealth:gt(),runtimeError:ht(),interruption:ft()?.interruption??null}}function O(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function de(t){return`<span style="color:${t==="HIGH"?"var(--green)":t==="MEDIUM"?"var(--yellow)":t==="LOW"?"var(--red)":"var(--text-dim)"};font-weight:600">${t}</span>`}function en(t){return t<=5?'<div style="font-size:11px;color:var(--text-dim);margin-top:6px">Classification: <b>NO SIGNIFICANT DEGRADATION OBSERVABLE</b> — timer resolution ≈ 1ms, so low-magnitude thermal throttling cannot be precisely resolved by this method.</div>':t<=20?'<div style="font-size:11px;color:var(--yellow);margin-top:6px">Classification: <b>MINOR PERFORMANCE DROP OBSERVED</b> — possibly thermal/sustained-load related; verify with a higher-resolution measurement method.</div>':'<div style="font-size:11px;color:var(--red);margin-top:6px">Classification: <b>SIGNIFICANT PERFORMANCE DROP</b> — likely sustained-load or thermal throttling; verify with a higher-resolution measurement method.</div>'}function tt(t){return t==null?"—":t<=0||!Number.isFinite(t)?"UNMEASURABLE":t<1?`${(t*1e3).toFixed(1)} µs`:`${t.toFixed(3)} ms`}function Ot(t){return t.throughput===null||t.throughput===void 0||!Number.isFinite(t.throughput)?t.notes.includes("INVALID")?"INVALID":"—":`${t.throughput.toFixed(2)} ${t.throughputUnit}`}function X(t,e){return e.length===0?"":`<div class="v3-section">
...
`;Et("aether-v3-1-llm-report.md",i,"text/markdown")}async function hn(t,e,o,i){const r=i?.resume??null;try{const a=e();Lt(ue());const{runLLMInferenceGate:n,runLLMInferenceGateQuick:s}=await nt(async()=>{const{runLLMInferenceGate:u,runLLMInferenceGateQuick:m}=await Promise.resolve().then(()=>ze);return{runLLMInferenceGate:u,runLLMInferenceGateQuick:m}},void 0);o("AETHER V3.1.3 RUNTIME ACTIVE","info"),o(`buildId: ${globalThis.AETHER_BUILD_ID??"unknown"}`,"info"),o("llmSuite: ENABLED","info"),o("memorySuite: ENABLED","info"),o("normalizedResults: ENABLED","info"),o("postExportAudit: ENABLED","info"),r&&o(`crash-safety: RESUMING interrupted run (${r.completed.length} categories cached)`,"info"),Ie("V3.1",t,{resume:r?{completed:r.completed,partial:r.partial}:void 0},globalThis.AETHER_BUILD_ID??null);const c=$e(a),d=Se(),l=t==="quick"?s:n;try{const u=await l(f=>o(`V3.1: ${f}`,"info"),r??void 0);xe(),d(),c(),fo(),Z=u;const{validateLLMGateIntegrity:m}=await nt(async()=>{const{validateLLMGateIntegrity:f}=await Promise.resolve().then(()=>Re);return{validateLLMGateIntegrity:f}},void 0),p=m(u);if(p.ok)o("V3.1 audit OK: normalization + throughput verified for LLM gate results.","ok");else{o(`V3.1 AUDIT FAILURES: ${p.issues.length}`,"err");for(const f of p.issues)o(`  - ${f.operation} ${f.workload}: ${f.detail}`,"err")}const g=await me(a);pn(u,g,o)}catch(u){d(),c();const m=u,p=`${m.message} ${m.stack??""}`.toLowerCase();p.includes("validation")?Ft("GPU_VALIDATION_ERROR",m.message,m):p.includes("limit")&&(p.includes("alloc")||p.includes("buffer")||p.includes("memory"))?Ft("RESOURCE_LIMIT",m.message,m):Ft("JAVASCRIPT_EXCEPTION",m.message,m),o(`V3.1 ERROR: ${m.message}`,"err"),o("crash-safety: benchmark interrupted (A–J), certification FAILED, partial results preserved. RELOAD the page and press RESUME.","warn")}}catch(a){o(`V3.1 ERROR: ${a.message}`,"err")}}async function In(t,e){try{const o=t();Lt(ue());const{runLLMDiagnosticStaged:i}=await nt(async()=>{const{runLLMDiagnosticStaged:d}=await Promise.resolve().then(()=>ze);return{runLLMDiagnosticStaged:d}},void 0);e("AETHER V3.1.3 STAGED DIAGNOSTIC ACTIVE","info"),Ie("V3.1","quick",void 0,globalThis.AETHER_BUILD_ID??null);const r=$e(o),a=Se(),n=await me(o),s=await i(d=>e(`DIAG: ${d}`,"info"));a(),r(),xe();for(const d of s){const l=d.completed?d.error?"ERROR":"DONE":"SKIPPED";e(`DIAG ${l}: ${d.label}${d.error?` — ${d.error}`:""} (${Math.round(d.durationMs)}ms)`,d.completed&&!d.error?"ok":"err")}e(`DIAG done: ${s.filter(d=>d.completed).length}/${s.length} stages completed`,"ok"),e(`DIAG env: ${n.device} | maxBufferSize: ${n.maxBufferSize?Math.round(n.maxBufferSize/1048576)+" MB":"UNAVAILABLE"} | timer: ${n.timerResolutionMs.toFixed(3)} ms`,"info");const c=Yo(s);Zo=s,tn=n,yn(s,c,n,e),e("crash-safety: diagnostic complete. Press EXPORT LLM JSON (above) to capture the full staged report.","info")}catch(o){e(`DIAG ERROR: ${o.message}`,"err")}}function yn(t,e,o,i){const r=document.getElementById("perf-v3-llm-results");if(!r)return;const a=t.filter(s=>s.completed).length,n=t.map(s=>{const c=s.completed?s.error?"ERROR":"DONE":"SKIPPED",d=s.completed&&!s.error?"var(--green)":"var(--red)";return`<div class="staged-row" style="display:flex;justify-content:space-between;gap:8px;padding:5px 0;border-bottom:1px solid var(--border)">
      <span style="font-size:12px">${O(s.label)}</span>
      <span style="font-size:12px;color:${d}"><b>${c}</b> ${Math.round(s.durationMs)}ms${s.error?` — ${O(s.error)}`:""}</span>
